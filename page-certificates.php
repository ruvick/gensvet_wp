      ...
      <div class="certificates-wrap">
        ...
        <div class="certificates-wrap-tabs">
          ...
          <div class="certificates-wrap-tabs-tab" data-target="2">
            ...
            ?>
                <div class="certificates-wrap-tabs-tab-card" data-target="cert2" data-src="<?php echo wp_get_attachment_image_src($item['awards_img'], 'large')[0]; ?>" data-title="<? echo $item['awards_title']; ?>" data-sub="<? echo $item['awards_text']; ?>">
                  <a href="#" class="certificates-wrap-tabs-tab-card-wrap">
