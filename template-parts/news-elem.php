<a href="<?echo get_the_permalink(get_the_ID());?>" class="newscom-wrap-card">
  ...
  <div class="newscom-wrap-card-link"> 
    <img src="<?php  $imgTm = get_the_post_thumbnail_url( get_the_ID(), "tominiatyre" ); echo empty($imgTm)?get_bloginfo("template_url")."/img/no-photo.jpg":$imgTm; ?>" alt="" class="newscom-wrap-card-link__img">
  </div>
</a>
