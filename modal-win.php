...
<div class="certificates-popup-container" data-target="cert1">
	...
	<div class="certificates-popup">
		...
		<img src="<?php echo get_template_directory_uri(); ?>/img/certificates/cert-popup.png" alt="" class="certificates-popup__img">
		<div class="certificates-popup-wrap">
			<h3 class="certificates-popup-wrap__title">Сертификат
				соответствия № НСОПБ.СН.ПР0261</h3>
			<p class="certificates-popup-wrap__desc">Убедитесь, что
				светильники отлично подходят Вашему объекту, закажите тестовый образец.
				Также, мы предоставляем безусловную гарантию 5 лет! Если в течении этого
				времени светильники выйдут из строя, мы бесплатно заменим их.
			</p>
